//Updated
const jsPsychImageSliderResponseInstrMAS = (function (jspsych) {
  "use strict";
  ...
  class CustomImageSliderResponsePlugin {
    ...
    trial(display_element, trial) {
      ...
      if (trial.concepts.length > 0) {
        let conceptHtml = "<div>";
        trial.concepts.forEach((concept) => {
          conceptHtml += `<p>${concept}</p>`;
        });
        conceptHtml += "</div>";
        display_element.insertAdjacentHTML("afterbegin", conceptHtml); // Insert concepts here
      }
      ...
      if (trial.render_on_canvas) {
        ...
        // Insert prompt1 above the slider
        if (trial.prompt1 !== null) {
          display_element.insertAdjacentHTML("afterbegin", trial.prompt1); // Insert prompt1 here
        }
        ...
        // Add prompt2 below the slider
        if (trial.prompt2 !== null) {
          display_element.insertAdjacentHTML("beforeend", trial.prompt2); // Insert prompt2 here
        }
